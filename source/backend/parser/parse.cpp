		...
		switch(New.Type)
		{
			...
			case FISHEYE_ORTHOGRAPHIC_CAMERA:
				EXPECT
					...
					CASE5( TETRA_TOKEN, CUBE_TOKEN, OCTA_TOKEN, ICOSA_TOKEN, STEREO_TOKEN )
					CASE( OMNI_DIRECTIONAL_STEREO_TOKEN )
						Expectation_Error("fisheye equidistant camera modifier");
					END_CASE
			...
			case FISHEYE_EQUISOLIDANGLE_CAMERA:
				EXPECT
					...
					CASE5( TETRA_TOKEN, CUBE_TOKEN, OCTA_TOKEN, ICOSA_TOKEN, STEREO_TOKEN )
					CASE( OMNI_DIRECTIONAL_STEREO_TOKEN )
						Expectation_Error("fisheye equisolid angle camera modifier");
					END_CASE
			...
			case FISHEYE_STEREOGRAPHIC_CAMERA:
				EXPECT
					...
					CASE5( TETRA_TOKEN, CUBE_TOKEN, OCTA_TOKEN, ICOSA_TOKEN, STEREO_TOKEN )
					CASE( OMNI_DIRECTIONAL_STEREO_TOKEN )
						Expectation_Error("fisheye stereographic camera modifier");
					END_CASE
