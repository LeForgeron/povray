...
class BicubicPatch : public ObjectBase
{
	...
	protected:
		...
		int intersect_bicubic_patch0(const Ray& , IStack&, TraceThreadData * Thread);
		...
		int bezier_subpatch_intersect(const Ray &, const VECTOR(*)[4][4], DBL, DBL, DBL, DBL, IStack&, TraceThreadData * Thread);
		...
		int bezier_subdivider(const Ray &, const VECTOR(*)[4][4], DBL, DBL, DBL, DBL, int, IStack&, TraceThreadData * Thread);
		...
		int bezier_tree_walker(const Ray &, const BEZIER_NODE *, IStack&, TraceThreadData * Thread);
